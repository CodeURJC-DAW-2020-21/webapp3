...
public class CategoryService {
    ...
    public void init(){
        ...
        this.save(new Category("Focus and Effort", "Do you want to be challenged daily? I challenge you to follow the pace of this category and\n" +
